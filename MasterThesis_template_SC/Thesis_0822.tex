...
The objectitve function $min \ T$ can be regarded as a function of $T(s, q)$. Therefore, we can regarded the pair $(s,q)$ as the new independent variables, and the the original problem \ref{TA_lower2} is then transformed into the following form
\begin{equation}
	\label{TA_Transform}
	\begin{aligned}
