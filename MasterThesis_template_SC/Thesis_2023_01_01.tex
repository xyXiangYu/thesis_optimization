...
\begin{figure}[H]
	\centerline{\includegraphics[width=12cm]{ca_compare_p0.png}}
...
\begin{figure}[H]
	\centerline{\includegraphics[width=12cm]{ca_compare_p5.png}}
...
\begin{figure}[H]
	\centerline{\includegraphics[width=12cm]{ca_compare_p9_old.png}}
...
As show above, both the classical approach and training approach leads to an identical solution with final time as $T=4.6053$, which is conservative with respective to oiriginal OCP \ref{rc}. The time $T=4.6053$ is conservative because regardless how the uncertain parameter $p$ takes the value in the uncertainty set $\mathbb{P}$, we can always find a feasible solution that leads to a final time that is less than or equal to $T=4.6053$. Neverthless, the classical approach and the training approach do not necessary lead to an identical solution for a general OCP under uncertainty. It happens that both approaches lead to the same solution to our chosen case purely because of the coincidence, and the worst case happens when $p=9$ at the right boundary point. % the classcical approach and training apporach lead 
